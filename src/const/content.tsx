...
export const FAQ_CONTENT: { question: string; answer: string | React.ReactElement }[] = [
  {
    ...
    answer: <>MEV or “maximal extractable value” is a method used by savvy traders (known as “searchers”) to exploit your trades at your expense. <br /><br />Any time you make a trade, searchers can “frontrun” it by submitting the exact same trade before you and keeping the profits from your slippage for themselves. After getting frontrun, you can also get “backrun”, which is where the searcher cleans up any price slippage your trade caused, again keeping the profits for themselves. Both a frontrun and a backrun together are known as a “sandwich attack” — the worst type of MEV.<br /><br />MEV gives you a worse price for your trade and can cause you to lose out on hundreds or even thousands of dollars. MEV Blocker is an easy solution – an RPC endpoint that protects all types of transactions from MEV.</>
  },
  {
    question: "What is an RPC endpoint?",
    answer: <>An RPC (remote procedure call) endpoint is used to connect applications like crypto wallets to the blockchain. <br /><br />MEV Blocker is a special RPC endpoint that ensures your trades are protected from MEV. It does this by sending your transaction to a network of searchers that scan for backrunning opportunities, but cannot frontrun or sandwich your trades. <br /><br />You can add RPC endpoints like MEV Blocker by changing the selected network in your crypto wallet. Some DeFi trading apps will also be able to integrate the MEV Blocker RPC endpoint directly — making it a default for all users. <a href={CONFIG.social.telegram.url} target="_blank" rel="noopener nofollow">Get in touch</a> if you&apos;re interested in doing this!</>
  },
  {
    question: "What kinds of MEV does MEV Blocker protect from?",
    answer: <>MEV Blocker protects from the most harmful forms of MEV attacks — frontrunning and sandwich attacks — for all types of dApps and Ethereum transactions.<br /><br />MEV Blocker also lets you benefit from backrunning. It does this by allowing searchers to “bid” in an auction to win the right to backrun your trade. When this happens, users of MEV Blocker receive 90% of the profit their backrunning opportunity created (compared with 0% today).<br /><br />In return for benefitting from backrunning your trade, these searchers are not allowed to frontrun or sandwich you — thus protecting you from the worst types of MEV.</>
  },
  {
    question: "When and where should I use MEV Blocker?",
    answer: <>You should use MEV Blocker as often as possible!<br /><br />While trading protocols like CoW Swap offer MEV protection for your DeFi trades, most other DeFi venues and NFT marketplaces do not provide any type of MEV protection.<br /><br />This is where MEV Blocker comes in: any user or dApp can implement it and it protects all types of transactions from MEV.</>
  },
  {
    question: "How do I install MEV Blocker?",
    answer: <>To use MEV Blocker, you will need to add the MEV Blocker RPC endpoint to your crypto wallet. You can do that easily by following the instructions <a href="#rpc">here</a>.<br /><br />If your wallet does not support adding RPC endpoints, you may have to contact your wallet developer to get MEV Blocker included as a supported RPC.</>
  },
  {
    question: "How does MEV Blocker work?",
    answer: <>MEV Blocker facilitates an auction between a network of “searchers” who are given the opportunity to backrun your transactions. In return, they protect you from frontrunning and sandwich attacks - the nasty types of MEV that exploit Ethereum users every day.<br /><br />To participate in the orderflow auction, searchers agree to share 90% of their profits with the wallets they backrun (compared with 0% profit share when not using MEV Blocker).<br /><br />As long as you have MEV Blocker set as the network in your wallet, you&apos;re protected from frontrunning and sandwiching when using any Ethereum dApp. And the profit share from backrunning is deposited automatically into your wallet.</>
  },
  {
