...
export const ERROR_ADD_MANUALLY_MESSAGE = { errorMessage: 'There was an error adding the RPC automatically to your wallet. Please add manually', isUserRejection: false, isError: true }
...
export function handleRpcError(error: any): { errorMessage: string | null, isUserRejection: boolean, isError: boolean } {
