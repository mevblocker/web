      ...
      <SectionWrapper backgroundColor={Color.blue} borderDown>
        <Section columns={2}>
          <SectionContent>
            ...
            <p className={'large-text'}>MEV Blocker is your personal protection from frontrunning and sandwich attacks
              for a broad spectrum of Ethereum transactions</p>
      ...
      <SectionWrapper backgroundColor={Color.yellow} borderDown>
        <Section>
          <SectionContent maxWidth={100} align={'center'}>
            ...
            <h5>MEV bots have extracted more than $1.38 billion from well-meaning Ethereum users across a variety of use
              cases (trading, providing liquidity, minting NFTs, etc). MEV Blocker is an RPC endpoint that supports
              these users by offering:</h5>
      ...
      <SectionWrapper backgroundColor={Color.pink} borderDown>
        <Section>
          <SectionContent maxWidth={100} align={'center'}>
            ...
            <p className={'centered-text'}>Having trouble? Check your wallet&apos;s documentation <br/> for instructions
              on how to update your RPC endpoint</p>
          </SectionContent>
